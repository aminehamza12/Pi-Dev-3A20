...
use GestionCvBundle\Entity\Evaluation;
...
class EvaluationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $evaluations = $em->getRepository('GestionCvBundle:Evaluation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('GestionCvBundle\Form\EvaluationType', $evaluation);
    ...
    {
        $deleteForm = $this->createDeleteForm($evaluation);
        $editForm = $this->createForm('GestionCvBundle\Form\EvaluationType', $evaluation);
